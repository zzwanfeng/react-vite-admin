    ...
    <Layout className='animated fadeIn'>
      ...
      <Row gutter={8}>
        ...
        <Col span={12}>
          <div className='base-style'>
            <Steps>
              <Step status='finish' title='Login' icon={iconToElement('UserOutlined', { fontSize: '2rem' })} />
              <Step status='finish' title='Verification' icon={iconToElement('SolutionOutlined', { fontSize: '2rem' })} />
              <Step status='process' title='Pay' icon={iconToElement('LoadingOutlined', { fontSize: '2rem' })} />
              <Step status='wait' title='Done' icon={iconToElement('SmileOutlined', { fontSize: '2rem' })} />
            </Steps>
          </div>
        </Col>
